...
const HomePage = () => {
    ...
    <div>
      ...
      <div className="homepage-container">
        <div className="homepage-content text-center">
          ...
          VTU Question Paper Hub is a comprehensive platform designed to provide BE Computer Science students with seamless access to previous years' question papers.
          </p>
  ...
  <div>
    ...
    <p style={{color:"blue"}}>Papers for this subject can be accessed below:</p>
